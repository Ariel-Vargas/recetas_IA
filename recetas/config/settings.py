...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'ingredientes',  # Nuestra app principal
]
...
# CORS settings - Configuración segura para desarrollo y producción
if DEBUG:
...
# Modelo BERT configuración - Usar variable de entorno o valor por defecto
model_path_env = os.getenv('MODEL_PATH', '../modelo_exportado')
MODEL_PATH = Path(model_path_env) if not Path(model_path_env).is_absolute() else Path(model_path_env)
if not MODEL_PATH.is_absolute():
    MODEL_PATH = BASE_DIR.parent / model_path_env.lstrip('../')
